        ...
        <div className="py-16 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-1">
            ...
            <p className="text-xs text-text-muted leading-relaxed max-w-[220px]">
              Digitizing manufacturing with smarter sourcing, instant quotes,
              and a supplier network built for innovators.
            </p>
          ...
          <div>
            ...
            <p className="text-xs font-semibold text-text-primary uppercase tracking-wider mb-4 mt-8">
              Partners
            </p>
