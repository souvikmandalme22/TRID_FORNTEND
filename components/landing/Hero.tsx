      ...
      <Container>
        <div className="text-center max-w-4xl mx-auto">
          <motion.div custom={0} variants={fadeUp} initial="hidden" animate="visible"
            ...
            <span className="text-accent text-sm font-medium tracking-wide">Manufacturing as a Service</span>
          </motion.div>
          ...
          <motion.p custom={0.2} variants={fadeUp} initial="hidden" animate="visible"
            ...
            Instant pricing. <span className="text-text-primary font-medium">Smart manufacturing.</span>
          ...
          <motion.div custom={0.45} variants={fadeUp} initial="hidden" animate="visible"
