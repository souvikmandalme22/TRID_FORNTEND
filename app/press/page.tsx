      ...
      <main className="min-h-screen pt-24 pb-20">
        ...
        <section className="max-w-4xl mx-auto px-6 text-center mb-20">
          ...
          <p className="text-text-muted text-lg leading-relaxed max-w-2xl mx-auto">
            For press enquiries, media kits, or interview requests — reach out
            to us directly. We're always happy to talk about the future of
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="bg-background border border-border rounded-2xl px-8 py-6 space-y-4">
              {[
                {
                  label: "Full Name",
                  value: "TRID Technologies Pvt. Ltd.",
                },
                {
                  label: "Founded",
                  value: "2024, India",
                ...
                {
                  label: "Category",
                  value: "Manufacturing-as-a-Service (MaaS)",
                },
                {
                  label: "Services",
                  value:
                ...
                },
                {
                  label: "Platform",
                  value:
                    "AI-powered instant quotation & supplier matching",
                },
                {
                  label: "Press Contact",
                ...
                <div
                  key={item.label}
                  className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-6 border-b border-border pb-4 last:border-0 last:pb-0"
                >
        ...
        <section className="max-w-5xl mx-auto px-6 mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              >
                <div
                  className={`${asset.preview} h-32 flex items-center justify-center`}
                >
                  <div
                    className={`flex items-center gap-2 ${asset.textColor}`}
                  >
        ...
        <section className="bg-surface border-y border-border py-20 mb-20">
          <div className="max-w-5xl mx-auto px-6 text-center">
            ...
            <p className="text-text-muted max-w-xl mx-auto mb-8">
              We're just getting started. Press coverage and media features will
              appear here as TRID grows.
            </p>
